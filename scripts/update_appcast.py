...
def empty_appcast() -> ET.ElementTree:
    ...
    ET.SubElement(channel, "title").text = "Enshittifier"
    ET.SubElement(channel, "link").text = "https://github.com/wr/enshittifier"
    ET.SubElement(channel, "description").text = "Enshittifier updates"
...
def main() -> int:
    ...
    ET.SubElement(item, "title").text = f"Enshittifier {args.version}"
    ET.SubElement(
        item,
        "pubDate",
